   ...
   <div className="calendar-grid mobile">
     {DAYS.map(day => {
       const dayEvents = selectedCourses
         ...
         .sort((a, b) => {
           const timeA = parseTime(a.slot.timings.find(t => t.day === day.substring(0, 3).toUpperCase()).startTime);
           const timeB = parseTime(b.slot.timings.find(t => t.day === day.substring(0, 3).toUpperCase()).startTime);
           return timeA - timeB;
         });
